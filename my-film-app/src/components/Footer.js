...
export const Footer = () => {
  return (
            ...
            <div className=" dark:bg-slate-900 bg-gray-200 ">
                <div className="max-w-2xl mx-auto dark:text-white text-gray-800 py-10">
                        ...
                        <div className="flex justify-center my-10">
                            <div className="flex items-center border rounded-lg  w-auto mx-2 transition-all px-4 py-2  border-red-700   hover:bg-red-700 hover:text-slate-200 cursor-pointer">
                                ...
                                <div className="text-left ml-3">
                                    <p className='text-xs dark:text-gray-200 text-gray-700'>Download on </p>
                    ...
                    <div className="mt-16 flex flex-col md:flex-row md:justify-center items-center text-sm  dark:text-gray-400 text-gray-700">
